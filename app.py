...
def model_predict2(image_path,model):
    ...
    if result == 0:
        return "The Patient is diagnosed with MonkeyPox, Patient need to be treated immediately!","result.html"        
    elif result == 1:
        return "The Patient is diagnosed with Mimickers, Please consult a physician","result.html"
...
@app.route("/notebook1")
def notebook1():
    return render_template("Without Augment.html")


@app.route("/notebook2")
def notebook2():
    return render_template("With Augment.html")
